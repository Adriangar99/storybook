...
- Addon-Docs: Title blocks to support `of` prop - [#23728](https://github.com/storybookjs/storybook/pull/23728), thanks @Sidnioulz!
...
- Blocks: Add support for `of` prop to `Subtitle` - [#22552](https://github.com/storybookjs/storybook/pull/22552), thanks @joaonunomota!
